...
public class ButtonA extends JButton {
    ...
    private Color shadowColor = new Color(240, 202, 78);  // Color de sombra modificado
    ...
    public ButtonA() {
        ...
        setBackground(new Color(240, 202, 78));  // Color de fondo modificado
